"""Minimal stand-in for the Hyperion issuer-relay router (DEMO only).
...
and real tests, without needing Thredd's actual codebase.
"""
from pathlib import Path
import yaml

CONFIG_PATH = Path(__file__).resolve().parents[1] / "config" / "hyperion" / "relay-routing.yaml"
